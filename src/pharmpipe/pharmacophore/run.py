...
from .build import build_pharmacophore
from .config import PharmacophoreConfig
from .io import write_features_csv, write_json, write_pml
...
def build_from_directory(input_dir: Path, out_dir: Path, cfg: PharmacophoreConfig,
                         ...
                         name: str | None = None) -> ModelOutputs:
    ...
    files = [
        ...
        write_pml(result.pharmacophore, input_dir, out_dir / "pharmacophore.pml",
                  cfg.features.colors),
...
def build_for_cell(cell_dir: Path, out_dir: Path, cfg: PharmacophoreConfig,
                   unique_ligands_csv: Path, name: str | None = None) -> ModelOutputs:
