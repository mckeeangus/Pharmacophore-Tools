# adora2a/orthosteric__positive — ensemble pharmacophore (11 features)
...
pseudoatom Donor_3, pos=[2.477, 90.362, 53.874], vdw=1.250
...
pseudoatom Acceptor_2, pos=[2.848, 92.568, 51.143], vdw=1.250
...
pseudoatom Acceptor_3, pos=[-0.420, 95.066, 51.279], vdw=1.250
...
pseudoatom Acceptor_4, pos=[0.510, 91.062, 50.743], vdw=1.250
...
pseudoatom PosIonizable_1, pos=[0.635, 95.067, 51.805], vdw=1.250
color ph4_PosIonizable, PosIonizable_1
group ph4_PosIonizable, PosIonizable_1
pseudoatom PosIonizable_1_ctr, pos=[0.635, 95.067, 51.805], label="PosIonizable 1 (0.83)"
color ph4_PosIonizable, PosIonizable_1_ctr
group ph4_centers, PosIonizable_1_ctr
pseudoatom Donor_4, pos=[1.669, 90.045, 49.924], vdw=1.250
...
pseudoatom Aromatic_2, pos=[1.178, 101.199, 56.411], vdw=1.250
