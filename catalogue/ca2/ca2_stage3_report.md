...
Cell mol2 sets: `groups/<pocket>__<efficacy>/`. Review sets: `review/{separate_state,unknown,quarantine}/`. Sessions: `ca2_grouped.pse` (all cells) and per-cell `.pse` in each folder.
