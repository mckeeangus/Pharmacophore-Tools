...
- `H09` (7QVJ_H09_A601, primary) — zwitterionic SERD-antagonist (degrader); PMID 36727211 (conf: high)
...
- `ND1` (6OWC_ND1_A601, primary) — H3B-6545 covalent antagonist (Y537S); deposit title (conf: high)
...
- `A1AHO` (8VZ0_A1AHO_A600, primary)
- `A1AHS` (8VZ1_A1AHS_C600, primary)
- `A1AHU` (8VYX_A1AHU_C600, primary)
- `A1AHV` (8VYT_A1AHV_D600, primary)
- `A1AHW` (8VZP_A1AHW_A601, primary)
- `A1AHX` (8VZQ_A1AHX_A601, primary)
- `A1AHY` (8W07_A1AHY_A601, primary)
- `A1AHZ` (8W07_A1AHZ_C601, primary)
- `A1AIZ` (9B25_A1AIZ_B600, primary)
- `WST` (2POG_WST_A201, primary)
